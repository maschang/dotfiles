...
-- コピーモード時は背景の透過度を変えて視覚的にわかるようにする
wezterm.on("update-right-status", function(window, pane)
  ...
  if in_copy_mode and not overrides.window_background_opacity then
    overrides.window_background_opacity = 1.0
    window:set_config_overrides(overrides)
  elseif not in_copy_mode and overrides.window_background_opacity then
